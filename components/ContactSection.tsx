...
const ContactSection: React.FC<{ id: string }> = ({ id }) => {
  return (
    ...
    >
      {/* Background Decorative Text - Increased visibility & contrast */}
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        >
          <p className="text-primary text-sm tracking-[0.3em] uppercase mb-6 font-semibold">Inquiries</p>
          <h2 className="font-serif text-6xl md:text-8xl text-textBase mb-12">
            Let's <span className="italic text-primary">Talk</span>
          </h2>

          <p className="text-xl font-normal text-textBase/90 mb-16 leading-relaxed max-w-xl mx-auto">
          ...
          <div className="mt-24 flex justify-center gap-12">
            {CONTACT_LINKS.map((link) => (
              <a
                ...
                className="text-sm font-semibold uppercase tracking-[0.2em] text-textBase/70 hover:text-primary transition-colors duration-300 border-b border-primary/30 hover:border-primary pb-1"
              >
                {link.name}
              </a>
            ))}
